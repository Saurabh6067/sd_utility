                        ...
                        <div class="card__wrapper">
                            <div class="d-flex align-items-center gap-sm">
                                ...
                                <div class="card__title-wrap">
                                    <h6 class="card__sub-title mb-10">Total Day</h6>
                                    <div class="card__content">
                                        <h3 class="card__title mb-5">30 Days</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card__wrapper">
                            <div class="d-flex align-items-center gap-sm">
                                ...
                                <div class="card__title-wrap">
                                    ...
                                    <div class="card__content">
                                        <h3 class="card__title mb-5"><?= $total_present ?> Days</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card__wrapper">
                            <div class="d-flex align-items-center gap-sm">
                                ...
                                <div class="card__title-wrap">
                                    ...
                                    <div class="card__content">
                                        <h3 class="card__title mb-5"><?= $total_half_days ?> Days</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card__wrapper">
                            <div class="d-flex align-items-center gap-sm">
                                ...
                                <div class="card__title-wrap">
                                    ...
                                    <div class="card__content">
                                        <h3 class="card__title mb-5">03 Days</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
