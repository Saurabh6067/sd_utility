            ...
            <div class="nav-item p-relative">
                ...
                <div class="user__dropdown">
                    <ul>
                        ...
                        <li>
                            <a href="app-chat.html"><svg width="18" height="17" viewbox="0 0 18 17" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li>
                            <a href="email-inbox.html"><svg width="18" height="13" viewbox="0 0 18 13" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li>
                            <a href="signup-basic.html"><svg width="18" height="18" viewbox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
